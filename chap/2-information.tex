...
Akaike in a series of papers \parencite{Akaike1973, Akaike:1974ih, Akaike1977,
...
behavior of the \mle and its relation to the \textcite{Kullback:1951va}'s measure
...
authors \parencite[e.g.][]{Stone:1982ck, Sawa:1978tn, Chow1981, Bozdogan1987,
...
\textcite{Akaike:1978ti} has a Bayesian interpretation of the \aic procedure for
...
On the other hand, as seen in \textcite{Akaike:1980gh}, using likelihood function
...
addition, as noted by \textcite{Kass:1995vb}, the Bayesian justification of \aic
...
structure and normal errors \parencite{Hurvich:1989ev, Burnham2002}. Under other
...
normal distribution. In such situations, as shown in \textcite{Zhou:2011uo} for
\pet data, \aicc does not perform well. It is possible to derive specific \aic
based information criterion for specific models, like \textcite{Hurvich:1989ev}
