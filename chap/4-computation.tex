...
posterior distribution $f(D|\bth)\pi(\bth)$. \textcite{Gelfand1994} suggested
...
especially for irregular likelihood function. \textcite{Chib1995} and
\textcite{Chib2001} considered specified methods for estimating the marginal
...
the setting of \mcmc algorithms \parencite[also see][for discussions of
results in this paper]{Besag1994,Chan1994,Doss1994,Robert:1994vh}. These
references provide all the results we will use in the following.
