...
stabilizing the harmonic mean estimator. For example \textcite{Hesterberg:1995wg}
...
\textcite{Raftery:2006ty} also discussed a method for improving the harmonic mean
...
algorithms. The last not least, the classical paper by \textcite{Tierney:1994uk}
...
paper]{Besag1994,Chan1994,Doss1994,Robert:1994vh}. These references provide all
...
parameter space $\bTh_k$ may be omitted \parencites[see][chap.~7]{Robert:2007tc}.
\endfirstyear
...
is variable. The core of \textcite{Green:1995dg}'s techniques is to construct an
...
\textcite{Green:1995dg} imposes a dimension matching condition which is that the
