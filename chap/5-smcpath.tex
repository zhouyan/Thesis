...
In summary, establish a reasonable general framework for using the proposed
methods to do Bayesian model comparison shall be the first step in the future
research. Various aspects of the methods, its optimization, etc. will be
concerns of later stage.
