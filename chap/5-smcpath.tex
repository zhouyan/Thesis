...
in \textcite{Liu:1998iu} that the effective sample size (\ess) is approximately
...
\parencite[e.g.][]{West:1993us}. Independent proposals appear to be dependent on
good behavior of the sequence $\{\pi_n\}$. One way to construct proposals
adaptively is proposed by \textcite{Jasra:2008bb}. However, it is still difficult
