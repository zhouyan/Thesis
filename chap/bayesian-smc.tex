...
\afterpage{\clearpage\input{tab/node-s}}
\afterpage{\clearpage\input{tab/node-c}}
...
Result from 100 replicate runs of the two algorithms under various regimes can
...
\afterpage{\clearpage\input{tab/pet-py}}
\afterpage{\clearpage\input{tab/pet-bf}}
