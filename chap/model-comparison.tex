...
\documentclass[10pt, hyper, bib, fontset=Lucida,
...
will be used as a base line for comparison in chapter~\note{Bayesian Model
  Comparison for Positron Emission Tomography Compartmental Models}. Then
...
\comment{This section need expansion to include some other widely used
  information based approaches or need a new title. At the moment this section
  is basically only \aic and related methods}
...
\parencite[see][chap.~1]{Bernardo:2000vd}.  The subjectivity and objectivity
...
As stated in chapter~\note{Introduction} we insist on the
...
sec.~6.1]{Bernardo:2000vd}, where the notion of rational decisions in the context
of uncertainty was made precise in the form of axioms
\parencite[see][chap.~2]{Bernardo:2000vd}. It is assumed that a rational decision
...
conjugate prior. See \textcite[][chap.~5]{Bernardo:2000vd} for its
