...
disciplines.
\sidenote{High level overview of model selection}
...
statistics.  \sidenote{Reference of comprehensive reviews}
...
situations. For non-parametric model selection, see\sidenote{Non-parametric
  model selection}
