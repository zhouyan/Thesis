...
that choose the model that is best for all these purposes. One simplified
criterion is to choose the ``true model''. In this case, it is natural to
define a zero-one utility function, say $u(\calM_k,\calM_t)$, defined by
\begin{equation}
  u(\calM_k,\calM_t) =
  \begin{cases}
...
weights to construct weighted estimator. This leads to the Bayesian model
averaging. See, for example \cite{Raftery:1997vx,Clyde:1999vx,Draper:1995vx},
