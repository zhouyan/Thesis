...
subchain of the resulting Markov chain that corresponds to the marginal
...
only using the subchain that corresponds to the distribution of interest).
...
subchain $\{X_t^{(i)}\}_{i=1}^N$. The integration~\eqref{eq:path integral}
