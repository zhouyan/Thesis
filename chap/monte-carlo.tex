...
\sidenote{This chapter still need some polish. Some phrasings are quite
  questionable (e.g., I found I use "in practice" far too often)}
...
\sidenote{I saw some discussions on geometrically ergodicity for 2-component
  Gibbs sampler but no general results}
