...
as the proposal scales of random walks. In addition, it does not allow more
flexible design of data structures which can lead to significant inefficiency
...
each iteration. The other is called \cppinline{mcmc}, and is performed after the
...
and the log-likelihood in the same way as the \cppinline{GMM} class. We can
