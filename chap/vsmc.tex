...
For those interested, Appendix~\appref{sec:Modern C++} serve as a brief
...
\afterpage{\input{fig/vsmc_bench_smp}\clearpage}
...
\afterpage{\input{fig/vsmc_bench_ocl}\clearpage}
