\UseAbbr[\kldfull][]{Kullback-Leibler divergence}
\UseAbbr[\sd]{s.d.}
\UseAbbr{aic}
\UseAbbr{ais}
\UseAbbr{bic}
...
\newcommand\aicc{\ifmmode\aic_c\else\aic{}$_c$\xspace\fi}
\newcommand\data{\mathbfit{y}}
\newcommand{\smc}[1][]{\textsc{smc}#1\xspace}
\newcommand\xth{\textsups{th}\xspace}
\newcommand\STATESKIP{\hskip.68cm}
\newcommand\Best[1]{\ifmmode\color{MRed}\text{\lnfigures\textbf{\textit{#1}}}
  \else\textcolor{MRed}{\textsf{\textbf{\textit{Red}}}}:\fi}
\newcommand\SubBest[1]{\ifmmode\color{MGreen}\text{\lnfigures\textit{#1}}
  \else\textcolor{MGreen}{\textsf{\textit{Green}}}:\fi}
  
\newcommand\dn[1]{\textcolor{MRed}{#1}}
